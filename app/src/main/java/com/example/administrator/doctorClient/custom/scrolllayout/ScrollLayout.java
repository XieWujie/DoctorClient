...
package com.example.administrator.doctorClient.custom.scrolllayout;
...
import com.example.administrator.doctorClient.custom.scrolllayout.content.ContentScrollView;
...
public class ScrollLayout extends FrameLayout {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.ScrollLayout_state)) {
            int mode = a.getInteger(R.styleable.ScrollLayout_state, 0);
            switch (mode) {
                case 0x0:
                    setToOpen();
                    break;
